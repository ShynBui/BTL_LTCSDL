    ...
    with app.app_context():
        ...
        user1 = User(name= "Bùi Tiến Phát", maSo= "2051052096", username="2051052096phat@ou.edu.vn",
                       ...
                       diachi="Gò Vấp", userRole=UserRole.SINHVIEN, idPerson=sv1.id,
                        dob=datetime.strptime("24-06-2002", '%d-%m-%Y').date(), avatar="https://scontent.fsgn2-4.fna.fbcdn.net/v/t39.30808-6/315256594_1475404026274288_2347858660450415372_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=hHWs69nbKWQAX-pWZsK&_nc_ht=scontent.fsgn2-4.fna&oh=00_AfAGpMT0HeQM2jUcDE2GIyLIN7u4TOUeUJUIbUv-EtN30A&oe=6446EE00")
        ...
        r1 = Rule(name='TIME', value=48)
        r2 = Rule(name='MINIMUM_IMPORT', value=150)
        r3 = Rule(name='MINIMUM_LIMIT', value=300)
